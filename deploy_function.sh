...
aws lambda update-function-code --function-name $AWS_LAMBDA_MAIN_FUNCTION_NAME --zip-file fileb://$MAIN_ARCHIVE_FILENAME $CLI_PROFILE_ARG
aws lambda update-function-code --function-name $AWS_LAMBDA_ADD_TO_DB_FUNCTION_NAME --zip-file fileb://$DB_HELPER_ARCHIVE_FILENAME $CLI_PROFILE_ARG


aws s3 cp ./code/frontend/index.html s3://$S3_STATIC_CONTENT_BUCKET_NAME$/index.html $CLI_PROFILE_ARG
aws s3 cp ./code/frontend/index.js s3://$S3_STATIC_CONTENT_BUCKET_NAME/index.js $CLI_PROFILE_ARG
aws s3 cp ./code/frontend/style.css s3://$S3_STATIC_CONTENT_BUCKET_NAME/style.css $CLI_PROFILE_ARG
aws s3 cp ./code/frontend/img/16th.png s3://$S3_STATIC_CONTENT_BUCKET_NAME/img/16th.png $CLI_PROFILE_ARG
aws s3 cp ./code/frontend/img/17th.png s3://$S3_STATIC_CONTENT_BUCKET_NAME/img/17th.png $CLI_PROFILE_ARG
aws s3 cp ./code/frontend/img/pin.png s3://$S3_STATIC_CONTENT_BUCKET_NAME/img/pin.png $CLI_PROFILE_ARG
